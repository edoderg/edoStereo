 ...
 * @updateUrl https://raw.githubusercontent.com/edoderg/edoStereo/main/edoStereo.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
    const config = {"main":"index.js","info":{"name":"edoStereo","authors":[{"name":"edo#0001","discord_id":"269831113919299584"}],"version":"0.0.2","description":"[GER] Fügt Stereo Sound zu deinem Discord hinzu. [ENG] Adds stereo sound to your discord. Better Discord v1.8.2 Fix edo#0001"},"changelog":[{"title":"Veränderungen","items":["BetterDiscord Stereo Sound Fix für 1.8.2"]}],"defaultConfig":[{"type":"switch","id":"enableToasts","name":"Benachrichtung Aktivieren","note":"Warnung für Spracheinstellungsfeatures","value":true}]};
